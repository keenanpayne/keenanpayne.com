...
const positiveQualities = [
  ...
  "professional", "reliable", "dependable", "efficient", "responsive", "communicative",
  "collaborative", "patient", "diligent", "organized", "punctual", "dedicated",
  
  // Technical skills
  "talented", "skilled", "expert", "experienced", "knowledgeable", "technical", "creative",
  "innovative", "cutting-edge", "magical", "wizard", "mastery", "robust",
  
  // Personal qualities
  "easy", "friendly", "kind", "pleasant", "laid-back", "cool-headed", "empathetic",
  "sharp", "intuitive", "smart", "intelligent", "thoughtful", "understanding",
  
  // Work quality
  "excellent", "outstanding", "exceptional", "amazing", "fantastic", "great", "wonderful",
  "beautiful", "elegant", "clean", "polished", "professional", "high-quality",
  
  // Communication & collaboration
  "clear", "transparent", "helpful", "supportive", "available", "accessible",
  "collaborative", "team-player", "communicative"
];

// Additional descriptive phrases to look for
const positivePhases = [
  "highly recommend", "highly recommended", "would recommend", "pleasure to work with",
  "easy to work with", "great to work with", "amazing to work with", "excellent job",
  "exceeded expectations", "above and beyond", "went above", "great value",
  "on time", "on schedule", "quick", "fast", "efficient", "timely"
];
...
function generateReport() {
  ...
  console.log(`Analysis date: ${new Date(analysis.analyzedAt).toLocaleDateString()}`);
  console.log("");
  ...
  analysis.topQualities.forEach((item, index) => {
    ...
    console.log(`${index + 1}. ${displayWord} (${item.count}x, ${item.percentage}%)`);
  });
